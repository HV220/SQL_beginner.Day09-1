...
VALUES(CURRENT_TIMESTAMP AT TIME ZONE 'Europe/Moscow', 'I', NEW."id",NEW."name",NEW."age",NEW."gender", NEW."address");
    ELSIF (TG_OP = 'UPDATE') THEN
         INSERT INTO "person_audit" ("created", "type_event", "row_id", "name", "age","gender" ,"address")
VALUES(CURRENT_TIMESTAMP AT TIME ZONE 'Europe/Moscow', 'U', OLD."id",OLD."name",OLD."age",OLD."gender", OLD."address");
    ELSIF (TG_OP = 'DELETE') THEN
         INSERT INTO "person_audit" ("created", "type_event", "row_id", "name", "age","gender" ,"address")
VALUES(CURRENT_TIMESTAMP AT TIME ZONE 'Europe/Moscow', 'D', OLD."id",OLD."name",OLD."age",OLD."gender", OLD."address");
    END IF;
    RETURN NULL;
END;
